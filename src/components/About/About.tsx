    ...
    >
      <div className="container about__layout">
        ...
        <div className="about__content">
          ...
          <p>
            QA Tester con experiencia en aseguramiento de la calidad de aplicaciones
            empresariales, enfocado en diseño de pruebas, análisis de defectos y
            mejora continua.
          </p>
          <p>
            ...
            etapas tempranas. Experiencia en pruebas funcionales, exploratorias, de
            regresión y de APIs dentro de entornos ágiles.
          </p>
